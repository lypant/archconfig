...
sudo pacman -S --noconfirm vim alsa-utils xorg-server xorg-server-utils xorg-xinit mesa virtualbox-guest-utils dmenu rxvt-unicode ttf-inconsolata ttf-dejavu git
...
#sudo chown "adam:users" "/etc/modules-load.d/virtualbox.conf"
#sudo chown "adam:users" "/home/adam/.bash_profile"
#sudo chown "adam:users" "/home/adam/.bashrc"
#sudo chown "adam:users" "/home/adam/.gitconfig"
#sudo chown -R "adam:users" "/home/adam/.vim"
#sudo chown "adam:users" "/home/adam/.vim/colors/solarized.vim"
#sudo chown "adam:users" "/home/adam/.vimrc"
#sudo chown "adam:users" "/home/adam/.Xdefaults"
#sudo chown "adam:users" "/home/adam/.xinitrc"
...
#echo "DWM_BUILD_PATH: $DWM_BUILD_PATH"
#sudo chown -R "adam:users" "$DWM_BUILD_PATH"
...
commentVarSudo UI /boot/syslinux/syslinux.cfg
